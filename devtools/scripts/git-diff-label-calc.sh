...
EXCLUDE_GENERATED_FILES_ARGS=$(git grep -l -e 'generated by .* DO NOT EDIT' | filter_nongen_files | sed 's/^/:\(exclude\)/')
...
EXCLUDE_IGNORED_FILES_ARGS=$(cat "$IGNORE_PATTERN_FILE" 2>/dev/null | resolve_git_files | sed 's/^/:\(exclude\)/')
