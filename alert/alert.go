...
func (a Alert) Normalize() (*Alert, error) {
	...
	err := validate.Many(
		...
		validate.OneOf("Source", a.Source, SourceManual, SourceGrafana, SourceSite24x7, SourcePrometheusAlertmanager, SourceCloudwatch, SourceEmail, SourceGeneric, SourceUniversal),
