...
var userGroupErrorMissing = template.Must(template.New("userGroupErrorMissing").Parse(`{{.ErrorMsg}}
...
var userGroupErrorEmpty = template.Must(template.New("userGroupErrorEmpty").Parse(`{{.ErrorMsg}}
...
var userGroupErrorUpdate = template.Must(template.New("userGroupErrorUpdate").Parse(`{{.ErrorMsg}}
