...
func (q *Queries) CleanMgrTrimEPOnCall(ctx context.Context, dollar_1 time.Time) (int64, error) {
	result, err := q.db.ExecContext(ctx, cleanMgrTrimEPOnCall, dollar_1)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected()
...
const cleanMgrTrimOverrides = `-- name: CleanMgrTrimOverrides :execrows
...
func (q *Queries) CleanMgrTrimOverrides(ctx context.Context, endTime time.Time) (int64, error) {
	result, err := q.db.ExecContext(ctx, cleanMgrTrimOverrides, endTime)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected()
...
const cleanMgrTrimSchedOnCall = `-- name: CleanMgrTrimSchedOnCall :execrows
...
func (q *Queries) CleanMgrTrimSchedOnCall(ctx context.Context, dollar_1 time.Time) (int64, error) {
	result, err := q.db.ExecContext(ctx, cleanMgrTrimSchedOnCall, dollar_1)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected()
