...
func (app *App) startup(ctx context.Context) error {
	...
	app.notificationManager.RegisterSender(email.DestType, "smtp", email.NewSender(ctx))
	app.notificationManager.RegisterSender(webhook.DestType, "webhook", webhook.NewSender(ctx))
