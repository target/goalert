...
export default function FlatList({
  ...
  function renderNoticeItem(item: FlatListNotice, idx: number): React.JSX.Element {
  ...
  function renderSubheaderItem(item: FlatListSub, idx: number): React.JSX.Element {
    return (
      <ListSubheader
        key={idx}
  ...
  function renderItems(): (React.JSX.Element | undefined)[] | React.JSX.Element {
