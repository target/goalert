...
export function PageNotFound(): React.ReactNode {
...
export function ObjectNotFound(props: ErrorsProps): React.ReactNode {
  const theme = useTheme()
  return (
    <div style={{ textAlign: 'center', color: theme.palette.text.primary }}>
      <SentimentDissatisfied style={{ height: '33vh', width: '33vw' }} />
...
export function GenericError(props: ErrorsProps): React.ReactNode {
  const theme = useTheme()
  let errorText
  if (props.error) {
