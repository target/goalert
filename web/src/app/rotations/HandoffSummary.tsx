...
function dur(p: HandoffSummaryProps): React.ReactNode | string {
...
function ts(p: HandoffSummaryProps): React.ReactNode | string {
  if (p.type === 'hourly')
...
export const HandoffSummary: React.FC<HandoffSummaryProps> =
  function HandoffSummary(props: HandoffSummaryProps): React.ReactNode {
