...
export function StringInput(props: InputProps): React.ReactNode {
  const [showPassword, setShowPassword] = useState(false)
  const { onChange, password, type = 'text', ...rest } = props

  const renderPasswordAdornment = (): React.ReactNode | null => {
...
export const StringListInput = (props: InputProps): React.ReactNode => {
...
export const IntegerInput = (props: InputProps): React.ReactNode => (
  <Input
    name={props.name}
    value={props.value}
...
export const BoolInput = (props: InputProps): React.ReactNode => (
  <Switch
    name={props.name}
    value={props.value}
