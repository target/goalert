...
export default function AdminServiceMetrics(): React.ReactNode {
  ...
  function renderOverviewMetrics(): React.ReactNode {
    return (
      <React.Fragment>
  ...
  function renderUsageGraphs(): React.ReactNode {
    return (
      <React.Fragment>
        <Grid item xs>
  ...
  function renderServiceTable(): React.ReactNode {
    return (
      <Card sx={{ marginTop: (theme) => theme.spacing(1) }}>
