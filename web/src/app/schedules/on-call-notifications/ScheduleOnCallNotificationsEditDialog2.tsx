...
interface ScheduleOnCallNotificationsEditDialog2Props {
  onClose: () => void
...
export default function ScheduleOnCallNotificationsEditDialog2(
  p: ScheduleOnCallNotificationsEditDialog2Props,
): JSX.Element {
