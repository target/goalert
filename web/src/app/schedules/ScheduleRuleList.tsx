...
import { AccountMultiplePlus, AccountPlus } from 'mdi-material-ui'
...
export default function ScheduleRuleList({
  scheduleID,
}: ScheduleRuleListProps): JSX.Element {
  ...
  function renderSubText(rules: any, timeZone: Zone): JSX.Element {
