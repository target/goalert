...
export interface DebugPhoneNumberInfo {
  id: string
  countryCode: string
  regionCode: string
  formatted: string
...
export interface DebugPhoneNumberCarrierInfo {
  name: string
  type: string
...
export interface DebugPhoneNumberInfoInput {
  number: string
}
...
export interface Mutation {
  debugPhoneNumberInfo: DebugPhoneNumberInfo
