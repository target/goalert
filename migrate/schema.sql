...
-- DATA=07e6bb5fc97fa3360273e2c071e8b96aa1e4d44ac603d3f0538df7ab7ff6f75e  -
...
CREATE TABLE service_rule_integration_key (
	...
	CONSTRAINT service_rule_integration_key_integration_key_id_fkey FOREIGN KEY (integration_key_id) REFERENCES integration_keys(id) ON DELETE CASCADE,
	CONSTRAINT service_rule_integration_key_pkey PRIMARY KEY (id),
	CONSTRAINT service_rule_integration_key_service_rule_id_fkey FOREIGN KEY (service_rule_id) REFERENCES service_rules(id) ON DELETE CASCADE
);

CREATE UNIQUE INDEX service_rule_integration_key_pkey ON public.service_rule_integration_key USING btree (id);
