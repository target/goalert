...
-- DATA=16df1b4efe4c463710bac60981c52f8ef2b05234f815ffde94979bdacf4322ee  -
-- DISK=e363175696c65c32920016cc9b06ae1551c72ce8f89302a7f139befdc886c19f  -
-- PSQL=e363175696c65c32920016cc9b06ae1551c72ce8f89302a7f139befdc886c19f  -
--
...
CREATE TRIGGER track_rotation_state_updates AFTER INSERT OR DELETE OR UPDATE ON public.rotation_participants FOR EACH ROW EXECUTE FUNCTION fn_track_rotation_updates();
...
CREATE TRIGGER trg_track_rotation_updates AFTER UPDATE ON public.rotation_state FOR EACH ROW EXECUTE FUNCTION fn_track_rotation_updates();
