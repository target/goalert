...
-- DATA=234570b66a7b229ccd1c080fa368e7b9f3a9ba3467c516bb3e38f2e8281a0d99  -
-- DISK=c39d440c9dcad4d130abd8d3b3ab6c498fb67ba95c3944effa841e8de3c785da  -
-- PSQL=c39d440c9dcad4d130abd8d3b3ab6c498fb67ba95c3944effa841e8de3c785da  -
--
...
CREATE TABLE integration_key_rules (
	...
	filterobj jsonb NOT NULL,
	id uuid DEFAULT gen_random_uuid() NOT NULL,
	integration_key_id uuid NOT NULL,
	msgtemplate jsonb NOT NULL,
	name text NOT NULL,
	...
	CONSTRAINT integration_key_rules_pkey PRIMARY KEY (id)
);

CREATE UNIQUE INDEX integration_key_rules_pkey ON public.integration_key_rules USING btree (id);
