...
-- DATA=f9d963e74a68b590b095dd59b6e413c8e9fa2c660f0fc50979a7cfb3a298c9fe  -
-- DISK=f332a69d8a35946d6d460dca37d0aa0bc909d214263874d0ff63aa2fd7043ebb  -
-- PSQL=f332a69d8a35946d6d460dca37d0aa0bc909d214263874d0ff63aa2fd7043ebb  -
--
...
CREATE TRIGGER trg_10_nc_set_dest_on_update BEFORE UPDATE ON public.notification_channels FOR EACH ROW WHEN ((new.dest = old.dest)) EXECUTE FUNCTION fn_nc_set_dest_on_insert();
...
CREATE TRIGGER trg_10_cm_set_dest_on_update BEFORE UPDATE ON public.user_contact_methods FOR EACH ROW WHEN ((new.dest = old.dest)) EXECUTE FUNCTION fn_cm_set_dest_on_insert();
