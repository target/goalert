...
-- DATA=85928167c9caa19094ca0adf157244b61eee1dac8fa3e72c3600234eba793716  -
-- DISK=949adb16bf89fb1c4cb9e3bd8c406cf0ad6fba4a35696dca47b6d5b8a7fd4979  -
-- PSQL=949adb16bf89fb1c4cb9e3bd8c406cf0ad6fba4a35696dca47b6d5b8a7fd4979  -
--
...
CREATE TABLE alert_comments (
	...
	id bigint DEFAULT nextval('alert_comments_id_seq'::regclass) NOT NULL,
	user_id uuid,
	CONSTRAINT alert_comments_alert_id_fkey FOREIGN KEY (alert_id) REFERENCES alerts(id) ON DELETE CASCADE,
	CONSTRAINT alert_comments_body_max_length CHECK (length(body) <= 4096),
	CONSTRAINT alert_comments_body_not_empty CHECK (length(TRIM(BOTH FROM body)) > 0),
	CONSTRAINT alert_comments_pkey PRIMARY KEY (id),
	CONSTRAINT alert_comments_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE SET NULL
);

CREATE UNIQUE INDEX alert_comments_pkey ON public.alert_comments USING btree (id);
CREATE INDEX idx_alert_comments_alert ON public.alert_comments USING btree (alert_id, created_at, id);
...
CREATE TABLE labels (
	...
	CONSTRAINT labels_tgt_ep_id_fkey FOREIGN KEY (tgt_ep_id) REFERENCES escalation_policies(id) ON DELETE CASCADE,
	CONSTRAINT labels_tgt_rotation_id_fkey FOREIGN KEY (tgt_rotation_id) REFERENCES rotations(id) ON DELETE CASCADE,
	CONSTRAINT labels_tgt_schedule_id_fkey FOREIGN KEY (tgt_schedule_id) REFERENCES schedules(id) ON DELETE CASCADE,
	CONSTRAINT labels_tgt_service_id_fkey FOREIGN KEY (tgt_service_id) REFERENCES services(id) ON DELETE CASCADE
);

CREATE UNIQUE INDEX idx_labels_resource_id ON public.labels USING btree (tgt_service_id, tgt_schedule_id, tgt_rotation_id, tgt_ep_id, key);
