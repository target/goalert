...
-- DISK=0bc7602e896fa75956e969791faa4e469ef984af481a6c83bf73d81c54a7ab01  -
-- PSQL=0bc7602e896fa75956e969791faa4e469ef984af481a6c83bf73d81c54a7ab01  -
--
...
CREATE TABLE api_keys (
	...
	CONSTRAINT api_keys_service_id_fkey FOREIGN KEY (service_id) REFERENCES services(id) ON DELETE CASCADE,
	CONSTRAINT api_keys_user_id_fkey FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
);

CREATE UNIQUE INDEX api_keys_name_key ON public.api_keys USING btree (name);
