...
-- DATA=d15af2a4dfae86b09766d70a2294f7e30ad10f456b4457a25a28a6be4b724089  -
-- DISK=6cae870f6f329cdc285fa198c546bf3745cb8859e68185a1dcf80c52641e0154  -
-- PSQL=6cae870f6f329cdc285fa198c546bf3745cb8859e68185a1dcf80c52641e0154  -
--
...
CREATE TABLE uik_samples (
	...
	user_note text,
	CONSTRAINT uik_samples_key_id_fkey FOREIGN KEY (key_id) REFERENCES integration_keys(id) ON DELETE CASCADE,
	CONSTRAINT uik_samples_pkey PRIMARY KEY (id)
);

CREATE UNIQUE INDEX uik_samples_pkey ON public.uik_samples USING btree (id);
CREATE INDEX uik_samples_uik_created_idx ON public.uik_samples USING btree (key_id, created_at DESC) WHERE ((user_note IS NULL) AND (failed = false));
CREATE INDEX uik_samples_uik_failed_idx ON public.uik_samples USING btree (key_id, created_at DESC) WHERE ((user_note IS NULL) AND (failed = true));
