...
-- DATA=36e3f554e89da373c50edd76220b9f96fab5f3585a23ffb07498d9553a0f3c82  -
-- DISK=fc66ac0c97c5a88839e76bab8397211c643163919910be8e16d20298cf6971ac  -
-- PSQL=fc66ac0c97c5a88839e76bab8397211c643163919910be8e16d20298cf6971ac  -
--
...
BEGIN
    ...
    IF val_count > max_count THEN
        ...
        USING ERRCODE = 'check_violation', CONSTRAINT = 'pending_signals_per_dest_per_service', HINT = 'max=' || max_count;
    END IF;
        RETURN NEW;
END;
$function$
...
BEGIN
    ...
    IF val_count > max_count THEN
        RAISE 'limit exceeded'
        USING ERRCODE = 'check_violation', CONSTRAINT = 'pending_signals_per_service', HINT = 'max=' || max_count;
    END IF;
        RETURN NEW;
END;
$function$
...
CREATE TABLE notification_channels (
	...
	value text NOT NULL,
	CONSTRAINT notification_channels_check CHECK (type <> 'DEST'::enum_notif_channel_type OR dest IS NOT NULL),
