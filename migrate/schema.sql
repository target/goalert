...
-- DATA=0db05fab55d1b15bfce59f9d62285eed6fcb96185e51b7b87ef4aa15103dc80a  -
-- DISK=6cb9ad96d905087ade8743905ee2b44317e3ac10b6e394fd36e18c3e024a01d4  -
-- PSQL=6cb9ad96d905087ade8743905ee2b44317e3ac10b6e394fd36e18c3e024a01d4  -
--
...
CREATE TABLE gql_api_keys (
	...
	CONSTRAINT gql_api_keys_name_key UNIQUE (name),
...
CREATE UNIQUE INDEX gql_api_keys_name_key ON public.gql_api_keys USING btree (name);
...
CREATE TABLE outgoing_signals (
	...
	service_id uuid NOT NULL,
	CONSTRAINT outgoing_signals_channel_id_fkey FOREIGN KEY (channel_id) REFERENCES notification_channels(id) ON DELETE CASCADE,
	CONSTRAINT outgoing_signals_pkey PRIMARY KEY (id),
	CONSTRAINT outgoing_signals_service_id_fkey FOREIGN KEY (service_id) REFERENCES services(id) ON DELETE CASCADE
);

CREATE UNIQUE INDEX outgoing_signals_pkey ON public.outgoing_signals USING btree (id);
...
CREATE TABLE service_rule_integration_keys (
	...
	service_rule_id uuid NOT NULL,
	CONSTRAINT service_rule_integration_keys_integration_key_id_fkey FOREIGN KEY (integration_key_id) REFERENCES integration_keys(id) ON DELETE CASCADE,
	CONSTRAINT service_rule_integration_keys_pkey PRIMARY KEY (id),
	CONSTRAINT service_rule_integration_keys_service_rule_id_fkey FOREIGN KEY (service_rule_id) REFERENCES service_rules(id) ON DELETE CASCADE,
	CONSTRAINT unique_int_key_service_rule UNIQUE (service_rule_id, integration_key_id)
);

CREATE UNIQUE INDEX service_rule_integration_keys_pkey ON public.service_rule_integration_keys USING btree (id);
CREATE UNIQUE INDEX unique_int_key_service_rule ON public.service_rule_integration_keys USING btree (service_rule_id, integration_key_id);
...
CREATE TABLE service_rules (
	...
	service_id uuid NOT NULL,
	CONSTRAINT service_rules_pkey PRIMARY KEY (id),
	CONSTRAINT service_rules_service_id_fkey FOREIGN KEY (service_id) REFERENCES services(id) ON DELETE CASCADE
);

CREATE UNIQUE INDEX service_rules_pkey ON public.service_rules USING btree (id);
...
CREATE TABLE signals (
	id bigint DEFAULT nextval('signals_id_seq'::regclass) NOT NULL,
	outgoing_payload jsonb NOT NULL,
	...
	CONSTRAINT signals_service_id_fkey FOREIGN KEY (service_id) REFERENCES services(id) ON DELETE CASCADE,
	CONSTRAINT signals_service_rule_id_fkey FOREIGN KEY (service_rule_id) REFERENCES service_rules(id) ON DELETE CASCADE
);
