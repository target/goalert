...
`
	...
	d2 := h.Twilio().Device(h.PhoneCC("+91", "1"))
	d3 := h.Twilio().Device(h.PhoneCC("+49", "1"))
	d4 := h.Twilio().Device(h.PhoneCC("+44", "1"))
	d5 := h.Twilio().Device(h.PhoneCC("+852", "1"))
	d6 := h.Twilio().Device(h.PhoneCC("+86", "1"))
	d7 := h.Twilio().Device(h.PhoneCC("+502", "1"))
