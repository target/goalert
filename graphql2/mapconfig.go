...
func MapConfigValues(cfg config.Config) []ConfigValue {
	return []ConfigValue{
		...
		{ID: "Twilio.AuthToken", Type: ConfigTypeString, Description: "The primary Auth Token for Twilio. Must be primary Unless Alternate Auth Token is set.", Value: cfg.Twilio.AuthToken, Password: true},
		{ID: "Twilio.AlternateAuthToken", Type: ConfigTypeString, Description: "An alternate Auth Token for validating requests. During a key change, set this to the current Primary, and Auth Token to Secondary, then promote and then clear this field.", Value: cfg.Twilio.AlternateAuthToken, Password: true},
