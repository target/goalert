...
func MapConfigValues(cfg config.Config) []ConfigValue {
	return []ConfigValue{
		...
		{ID: "General.DisableV1GraphQL", Type: ConfigTypeBoolean, Description: "Deprecated API. Disables the ability to use the /v1/graphql api. Please use /api/graphql instead.", Value: fmt.Sprintf("%t", cfg.General.DisableV1GraphQL)},
