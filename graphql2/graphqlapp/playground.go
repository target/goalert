...
<head>
	...
	<link rel="stylesheet" href="//cdn.jsdelivr.net/npm/{{ .PackageName }}@{{ .Version }}/build/static/css/index.css"/>
	<link rel="shortcut icon" href="//cdn.jsdelivr.net/npm/{{ .PackageName }}@{{ .Version }}/build/favicon.png"/>
