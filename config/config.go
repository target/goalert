...
type Config struct {
	...
	General struct {
		...
		DisableCalendarSubscriptions bool   `public:"true" info:"Disables all active calendar subscriptions as well as the ability to create new calendar subscriptions."`
	}
